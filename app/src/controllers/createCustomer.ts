...
export async function createCustomer(req: FastifyRequest, res: FastifyReply): Promise<CodeMessage | BaseError> {
  ...
  try {
    ...
    const response = error_handler(logger, error, 'CreateCustomer');
