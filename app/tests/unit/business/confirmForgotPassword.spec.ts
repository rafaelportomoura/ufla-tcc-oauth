...
describe('Business -> ConfirmForgotPassword', async () => {
  ...
  it('Should confirm', async () => {
    ...
    await confirm_forgot_password.confirm(AuthorizerData.confirmForgotPassword());
  ...
  it('Should not confirm', async () => {
    ...
    const response = await confirm_forgot_password.confirm(AuthorizerData.confirmForgotPassword()).catch((e) => e);
    Sinon.assert.calledOnce(confirm_forgot_password_stub);
